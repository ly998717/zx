...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="container">
  <tr>
    <td width="670" valign="top"><form action="updateQuestion" method="post" onsubmit="return checkquestion()">
        ...
        <tr>
          <td align="center"><table width="90%" border="0" cellpadding="5" cellspacing="0" id="userinfo_content">
            ...
            <tr>
              ...
              <td width="27%"><span id="oldAMsg"></td>
              </tr>
            <tr>
