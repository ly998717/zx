    ...
    <table align="center" id="page">
        ...
        <td align="right">
        	<c:if test="${pageBean.page!=1}">
   				<a href="pageUpAndDown?operation=Up&pageId=${pageBean.page}&action=collect" style="text-decoration:none">上一页</a>&nbsp; &nbsp;     
        	</c:if>
        	第&nbsp; ${pageBean.page} &nbsp;页 &nbsp;&nbsp;
        	<c:if test="${pageBean.page != pageBean.totalPage}">
          		<a href="pageUpAndDown?operation=Down&pageId=${pageBean.page}&action=collect" style="text-decoration:none">下一页</a>
        	</c:if> 
          	&nbsp;&nbsp;&nbsp;&nbsp;
