...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="container">
  <tr>
    ...
    <table border="0" align="center" cellpadding="5" cellspacing="0" id="guanzhu">
      <tr>
        <td>共有 ${loginUser.fans}人关注我</td><td align="right"></td>
      </tr>
    </table>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
        ...
        <!-- weibo 开始-->
 <c:forEach items="${fans}" var="attUser">
	        ...
	        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="curruserdetail">
	         ...
	         <tr>
			  ...
			  <tr>
			    ...
			    <td>
			    	<c:if test="${attUser.state == 0}"><a href="friendOperation?operation=GZ&nPage=fans&uId=${attUser.id}" style="text-decoration:none">关注用户</a></c:if>
			    	<c:if test="${attUser.state == 1}"><a href="friendOperation?operation=QXGZ&nPage=fans&uId=${attUser.id}" style="text-decoration:none">互相关注</a></c:if>
			    	</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
			    <td>${attUser.sign}</td>
			    <td><a href="friendOperation?operation=LH&nPage=fans&uId=${attUser.id}" style="text-decoration:none">拉黑</a></td>
			  </tr>
	        </table>
	    </td>
	   </tr>
    ...
    <!-- 分页开始 -->
        ...
        <td align="right">
        	<c:if test="${pageBean.page!=1}">
   				<a href="fans_index?p=${pageBean.page-1}" style="text-decoration:none">上一页</a>&nbsp; &nbsp;     
        	</c:if>
        	第&nbsp; ${pageBean.page} &nbsp;页 &nbsp;&nbsp;
        	<c:if test="${pageBean.page != pageBean.totalPage}">
          		<a href="fans_index?p=${pageBean.page+1}" style="text-decoration:none">下一页</a>
        	</c:if> 
          	&nbsp;&nbsp;&nbsp;&nbsp;
