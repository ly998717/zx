	        ...
	        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="curruserdetail">
	         ...
	         <tr>
			  ...
			  <tr>
			    ...
			    <td><a href="toBlackOrQXGZ?operation=QXGZ&bId=${attUser.id}" style="text-decoration:none">已关注</a></td>
			  </tr>
			  <tr>
    ...
    <!-- 分页开始 -->
        ...
        <td align="right">
        	<c:if test="${pageBean.page!=1}">
   				<a href="AF_pageUpAndDown?operation=Up&pageId=${pageBean.page}" style="text-decoration:none">上一页</a>&nbsp; &nbsp;     
        	</c:if>
        	第&nbsp; ${pageBean.page} &nbsp;页 &nbsp;&nbsp;
        	<c:if test="${pageBean.page != pageBean.totalPage}">
          		<a href="AF_pageUpAndDown?operation=Down&pageId=${pageBean.page}" style="text-decoration:none">下一页</a>
        	</c:if> 
          	&nbsp;&nbsp;&nbsp;&nbsp;
